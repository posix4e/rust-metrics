...
impl ::protobuf::Message for Summary {
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        for value in self.sample_count.iter() {
            my_size += ::protobuf::rt::value_size(1, *value, ::protobuf::wire_format::WireTypeVarint);
        };
        if self.sample_sum.is_some() {
            my_size += 9;
        };
        for value in self.quantile.iter() {
...
impl ::protobuf::Message for Bucket {
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        for value in self.cumulative_count.iter() {
            my_size += ::protobuf::rt::value_size(1, *value, ::protobuf::wire_format::WireTypeVarint);
        };
...
impl ::protobuf::Message for Metric {
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in self.untyped.iter() {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        };
        for value in self.histogram.iter() {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        };
        for value in self.timestamp_ms.iter() {
...
impl ::protobuf::Message for MetricFamily {
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in self.help.iter() {
            my_size += ::protobuf::rt::string_size(2, &value);
        };
        for value in self.field_type.iter() {
            my_size += ::protobuf::rt::enum_size(3, *value);
        };
        for value in self.metric.iter() {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        };
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
